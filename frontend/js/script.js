            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (result.role === 'admin') {
                        window.location.href = 'http://localhost:3000/admin/admin'; // Redirect to admin's home page
                    } else if (result.role === 'user') {
                        window.location.href = 'http://localhost:3000'; // Redirect to user's home page
                    } else {
                        window.location.href = 'http://localhost:3000/vendor/mitra'; // Redirect to vendor's home page                        
                    }
                } else {
