...
<a class="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover zoom-effect-container" href="#"> Lavatory Fresh</a> 
  ...
  <hr>
    ...
    <div class="row">
      <div class="col-md-8">
        <h1>Lavatory Fresh</h1>
        <p class="text-muted">Jl. Sudirman No.42, Jakarta Pusat, DKI Jakarta 10210</p>
        <p>LavatoryFresh Cleaning Services adalah perusahaan jasa pembersihan lavatory yang menawarkan layanan pembersihan menyeluruh dengan standar kebersihan tertinggi. Kami menggunakan produk pembersih yang kuat namun ramah lingkungan untuk memastikan lavatory Anda selalu bersih, higienis, dan bebas dari bakteri. Tim kami yang terlatih siap memberikan hasil terbaik untuk kenyamanan Anda.</p>
        <p class="text-muted">Rating</p>
      </div>
      <div class="col-md-4">
        <img src="/images/index/lavatory/lavatory2.jpg" class="custom-image rounded mx-auto d-block" style="width: 200px; height: 200px" alt="Nama Perusahaan">
      </div>
    </div>
    ...
    return {
      services: [
        ...
        },
        {
          ...
          price: 120000,
          image: '/images/index/lavatory/lava3.jpg'
        }
      ],
      cart: []
    };
