...
<a class="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover zoom-effect-container" href="#"> CrytalClear PS</a> 
  ...
  <hr>
    ...
    <div class="row">
      <div class="col-md-8">
        <h1>Crystal Clear Pool Service</h1>
        <p class="text-muted">Jl. Riau No.2, Jakarta Selatan, DKI Jakarta 10311</p>
        <p>CrystalClear Pool Services adalah penyedia layanan pembersihan kolam renang yang berfokus pada kepuasan pelanggan dengan hasil yang berkualitas. Tim profesional kami dilengkapi dengan teknologi terbaru dan pengetahuan mendalam tentang perawatan kolam renang, memastikan kolam Anda tetap bersih, sehat, dan mengundang untuk berenang.</p>
        <p class="text-muted">Rating</p>
      </div>
      <div class="col-md-4">
        <img src="/images/index/pool/pool2.jpg" class="custom-image rounded mx-auto d-block" style="width: 200px; height: 200px" alt="Nama Perusahaan">
      </div>
    </div>
