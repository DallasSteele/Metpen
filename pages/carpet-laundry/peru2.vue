...
<a class="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover zoom-effect-container" href="#"> FreshRug Laundry</a> 
  ...
  <hr>
    ...
    <div class="row">
      <div class="col-md-8">
        <h1>FreshRug Laundry</h1>
        <p class="text-muted">Jl. Diponegoro No.12, Jakarta Selatan, Jawa Barat 40115</p>
        <p>FreshRug Laundry adalah penyedia layanan laundry karpet yang mengutamakan kebersihan dan kepuasan pelanggan. Dengan menggunakan bahan-bahan pembersih yang aman dan teknik pembersihan modern, kami memastikan karpet Anda bersih, harum, dan bebas dari kuman.</p>
        <p class="text-muted">Rating</p>
      </div>
      <div class="col-md-4">
        <img src="/images/index/carpet/carpet-company2.jpg" class="custom-image rounded mx-auto d-block" style="width: 200px; height: 200px" alt="Nama Perusahaan">
      </div>
    </div>
