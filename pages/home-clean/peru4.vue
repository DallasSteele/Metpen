...
<a class="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover zoom-effect-container" href="/home-clean/home-page"> Home Clean</a> <a class="text-muted text-decoration-none" href="#"> >> </a>
<a class="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover zoom-effect-container" href="#"> Home Shine</a> 
  ...
  <hr>
    ...
    <div class="row">
      <div class="col-md-8">
        <h1>Home Shine</h1>
        <p class="text-muted">Jl. Thamrin No. 24-25, Jakarta Pusat, DKI Jakarta 102300</p>
        <p>HomeShine Cleaning Services adalah perusahaan jasa pembersihan rumah yang menawarkan layanan pembersihan menyeluruh dan mendetail. Kami menggunakan produk pembersih berkualitas tinggi dan ramah lingkungan untuk memastikan rumah Anda bersih, sehat, dan nyaman untuk ditempati. Tim kami yang profesional dan terlatih siap memberikan hasil terbaik untuk kepuasan Anda.</p>
        <p class="text-muted">Rating</p>
      </div>
      <div class="col-md-4">
        <img src="/images/index/home-clean/homeclean1.jpg" class="custom-image rounded mx-auto d-block" style="width: 200px; height: 200px" alt="Nama Perusahaan">
      </div>
    </div>
      ...
      services: [
        {
          ...
          price: 45000,
          image: '/images/index/home-clean/homecleaning1.jpg'
        },
        {
          ...
          price: 80000,
          image: '/images/index/home-clean/homecleaning2.jpg'
        },
        {
          ...
          price: 120000,
          image: '/images/index/home-clean/homecleaning3.jpg'
        }
      ],
      cart: []
    };
