...
<a class="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover zoom-effect-container" href="#"> Pristine House</a> 
  ...
  <hr>
    ...
    <div class="row">
      <div class="col-md-8">
        <h1>Pristine House</h1>
        <p class="text-muted">Jl. Demor No.66, Jakarta Barat, DKI Jakarta 11220</p>
        <p>PristineHouse Cleaning adalah solusi terbaik untuk semua kebutuhan pembersihan rumah Anda. Kami menawarkan layanan pembersihan rumah secara menyeluruh dengan perhatian pada setiap detail. Tim kami yang berpengalaman akan memastikan setiap sudut rumah Anda bersih dan nyaman untuk ditempati. Kami juga menyediakan layanan pembersihan khusus sesuai permintaan pelanggan.</p>
        <p class="text-muted">Rating</p>
      </div>
      <div class="col-md-4">
        <img src="/images/index/home-clean/homeclean3.jpg" class="custom-image rounded mx-auto d-block" style="width: 200px; height: 200px" alt="Nama Perusahaan">
      </div>
    </div>
