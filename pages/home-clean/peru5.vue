...
<a class="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover zoom-effect-container" href="#"> Sparkle</a> 
  ...
  <hr>
    ...
    <div class="row">
      <div class="col-md-8">
        <h1>Sparkle</h1>
        <p class="text-muted">Jl. Braga No.11, Jakarta Barat, DKI Jakarta 10221</p>
        <p>SparkleHome Cleaners adalah penyedia layanan pembersihan rumah yang mengutamakan kepuasan pelanggan dengan layanan yang cepat, efisien, dan terpercaya. Kami menawarkan berbagai paket pembersihan sesuai kebutuhan Anda, mulai dari pembersihan rutin hingga pembersihan mendalam. Dengan teknologi pembersihan terbaru, kami menjamin rumah Anda akan bersinar dan bebas dari debu serta kotoran.</p>
        <p class="text-muted">Rating</p>
      </div>
      <div class="col-md-4">
        <img src="/images/index/home-clean/homeclean2.jpg" class="custom-image rounded mx-auto d-block" style="width: 200px; height: 200px" alt="Nama Perusahaan">
      </div>
    </div>
